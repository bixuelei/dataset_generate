...
def main() :
    ...
    ################################################
    ####  the initialised size, used to check the configuration in all set  ####
    ################################################
    
    while(True):
        save_dir_TypeA1 = "/Users/bixuelei/Master/Center_position/TypeA1"
        save_dir_TypeA2 = "/Users/bixuelei/Master/center_position/TypeA2"
        save_dir_TypeANone = "/Users/bixuelei/Master/center_position/TypeANone"
        changed_parameter = {}
        changed_parameter['changed_BL'] = float(5.0)          # Bottom_Length
        changed_parameter['changed_SBL'] = float(1.3)         # Sub_Bottom_Length
        changed_parameter['changed_LGD'] = float(4.0)         # Lower_Gear_Diameter
        changed_parameter['changed_LGP'] = float(3.9)         # Lower_Gear_Position
        changed_parameter['changed_UGD'] = float(5.75)           # Upper_Gear_Diameter
        ###########################################  
