...
def main() :
    ...
    for _ in range(number_motor):
        save_dir_TypeB = "F:\Thesis\Center_position\TypeB"
        save_dir_TypeBNone = "F:\Thesis\Center_position\TypeNone"
        changed_parameter = {}
        changed_parameter['changed_BL'] = float(6)          # Bottom_Length
        changed_parameter['changed_SBL'] = float(1.3)         # Sub_Bottom_Length
        changed_parameter['changed_LGD'] = float(4)         # Lower_Gear_Diameter
        changed_parameter['changed_LGP'] = float(3.9)         # Lower_Gear_Position
        changed_parameter['changed_GBR'] = float(2.85)         # Gear_Bolt_Right_B
        changed_parameter['changed_HEL'] = float(6.9)         # Height of Extension left
        changed_parameter['changed_HER'] = float(4.5)         # Height of Extension right
        ###########################################  
