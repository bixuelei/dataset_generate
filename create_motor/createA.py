...
def main() :
    ...
    save_dir_TypeA1 = "/Users/bixuelei/Master/AllTypeParts/TypeA1"
    save_dir_TypeA2 = "/Users/bixuelei/Master/AllTypeParts/TypeA2"
    save_dir_TypeANone = "/Users/bixuelei/Master/AllTypeParts/TypeNone"
    ...
    for _ in range(number_motor):
        ...
        ###########################################
        create_Motor_Obj_A(Extension_Type_A = 'mf_Extension_Type_1', Bolt_type_mode = 'Torx', changed_parameter = changed_parameter, Upper_Bolt_Nummber=Upper_Bolt_Nummber[0], save_dir = save_dir_TypeA1)

        ###########################################  
        #   Create Type A Extension 2 Motor       #
        ###########################################
        create_Motor_Obj_A(Extension_Type_A = 'mf_Extension_Type_2', Bolt_type_mode = 'Torx', changed_parameter = changed_parameter, Upper_Bolt_Nummber=Upper_Bolt_Nummber[0], save_dir = save_dir_TypeA2)

        ###########################################  
        #   Create Type A Extension None Motor    #
        ###########################################
        create_Motor_Obj_A(Extension_Type_A = 'mf_Extension_Type_None', Bolt_type_mode = 'Torx', changed_parameter = changed_parameter, Upper_Bolt_Nummber=Upper_Bolt_Nummber[0], save_dir = save_dir_TypeANone)
    ...
    for _ in range(number_motor):
        ...
        #   Create Type A Extension 1 Motor       #
        ###########################################
        create_Motor_Obj_A(Extension_Type_A = 'mf_Extension_Type_1', Bolt_type_mode = 'Torx', changed_parameter = changed_parameter, Upper_Bolt_Nummber=Upper_Bolt_Nummber[1], save_dir = save_dir_TypeA1)

        ###########################################  
        #   Create Type A Extension 2 Motor       #
        ###########################################
        create_Motor_Obj_A(Extension_Type_A = 'mf_Extension_Type_2', Bolt_type_mode = 'Torx', changed_parameter = changed_parameter, Upper_Bolt_Nummber=Upper_Bolt_Nummber[1], save_dir = save_dir_TypeA2)

        ###########################################  
        #   Create Type A Extension None Motor    #
        ###########################################
        create_Motor_Obj_A(Extension_Type_A = 'mf_Extension_Type_None', Bolt_type_mode = 'Torx', changed_parameter = changed_parameter, Upper_Bolt_Nummber=Upper_Bolt_Nummber[1], save_dir = save_dir_TypeANone)
