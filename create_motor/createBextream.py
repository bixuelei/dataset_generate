...
def main() :
    ...
    for _ in range(number_motor):
        changed_parameter = {}
        save_dir_TypeB = "F:\Thesis\Extream_type\TypeBsmall"
        save_dir_TypeBNone = "F:\Thesis\Extream_type\TypeNonesmall"
        changed_parameter['changed_BL'] = float(4.0)          # Bottom_Length
        changed_parameter['changed_SBL'] = float(0.6)         # Sub_Bottom_Length
        changed_parameter['changed_LGD'] = float(3.5)         # Lower_Gear_Diameter
        changed_parameter['changed_LGP'] = float(3.6)         # Lower_Gear_Position
        changed_parameter['changed_GBR'] = float(1.7)            # Gear_Bolt_Right_B
        changed_parameter['changed_HEL'] = float(6.3)         # Height of Extension left
        changed_parameter['changed_HER'] = float(3.0)         # Height of Extension right
        ###########################################  
    ...
    for _ in range(number_motor):
        changed_parameter = {}
        save_dir_TypeB = "F:\Thesis\Extream_type\TypeBbig"
        save_dir_TypeBNone = "F:\Thesis\Extream_type\TypeNonebig"
        changed_parameter['changed_BL'] = float(8.0)          # Bottom_Length
        changed_parameter['changed_SBL'] = float(2.0)         # Sub_Bottom_Length
        changed_parameter['changed_LGD'] = float(4.5)         # Lower_Gear_Diameter
        changed_parameter['changed_LGP'] = float(4.2)         # Lower_Gear_Position
        changed_parameter['changed_GBR'] = float(4.0)         # Gear_Bolt_Right_B
        changed_parameter['changed_HEL'] = float(7.5)         # Height of Extension left
        changed_parameter['changed_HER'] = float(6.0)         # Height of Extension right
